...
function addProduct(){
	$("#pform").attr("action","/product/toAdd.do");
...
<div class="box-positon">
	...
	<form class="ropt">
		<input class="add" type="button" value="添加" onclick="addProduct()"/>
	</form>
	<div class="clear"></div>
</div>
<div class="body-box">
<form id="pform" action="/product/list.do" method="post" style="padding-top:5px;">
